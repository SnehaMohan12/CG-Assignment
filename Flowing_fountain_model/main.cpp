...
glColor3f(0.6,0.8,0.7);
DrawTextXY(-1.6,3,0.0,0.0014," FLOWING FOUNTAIN ");
glColor3f(0.7,0.6,0.1);
DrawTextXY(-3.25,1.5,0.0,0.0007," Submitted by :- ");
glColor3f(1.0,0.5,0.0);
DrawTextXY(-2.5,1.2,0.0,0.001," SNEHA M ");
DrawTextXY(1,1.2,0.0,0.001," SHIVANI GUJJA ");
glColor3f(0.7,0.8,0.6);
DrawTextXY(-2.5,0.95,0.0,0.001," (1BY18CS166) ");
DrawTextXY(1,0.95,0.0,0.001," (1BY18CS154) ");
glColor3f(0.7,0.6,0.1);
DrawTextXY(-1.25,0,0.0,0.0007," Under the guidance of : ");
glColor3f(1.0,0.8,0.4);
DrawTextXY(-1.15,-.2,0.0,0.001," MR SHANKAR R");
DrawTextXY(-2.5,-.5,0.0,0.0012," ASSISTANT PROFESSOR,Dept. of CSE ");
DrawTextXY(-2.7,-.7,0.0,0.001," BMS INSTITUTE OF TECHNOLOGY AND MANAGEMENT");
